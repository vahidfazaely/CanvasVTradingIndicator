...
How to verify the strategy in TradingView and locally. Current baseline: **v4.2.1**.
...
Expected production baselines (full window, v4.2.1 defaults): **BTC 48t / +9.84R · ETH 46t / +4.70R · SOL 38t / +5.28R**. Small differences after data refresh are normal; large ones mean a logic or data change — investigate before trusting results.
